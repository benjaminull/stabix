...
class GuestBookingSerializer(serializers.Serializer):
    ...
    service = serializers.IntegerField(required=False, default=0)
    location_lat = serializers.FloatField()
    location_lng = serializers.FloatField()
    details = serializers.CharField(min_length=10)
    preferred_date = serializers.DateField()
    preferred_time_slot = serializers.CharField(required=False, default="")
    # New: specific start/end datetimes from available-slots endpoint
